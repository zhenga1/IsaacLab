...
# Path to the sim directory: C:\Users\aaron\IsaacLab\source\isaaclab\isaaclab\sim\spawners\shapes\shapes_cfg.py
...
def design_scene():
    ...
    ball_object = RigidObject(cfg=ball_cfg)

    # return the scene information
    scene_entities = {"cone": ball_object}
